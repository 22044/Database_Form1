...
namespace Database_Form1 {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentRow AddStudentRow(int Enroll_No, string Name, string Branch, string Sem, string Address, string Gender, byte[] Picture) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentRow FindByEnroll_No(int Enroll_No) {
        ...
        public partial class StudentRow : global::System.Data.DataRow {
            ...
            public int Enroll_No {
                get {
                    return ((int)(this[this.tableStudent.Enroll_NoColumn]));
                }
                set {
                    this[this.tableStudent.Enroll_NoColumn] = value;
                }
            }
...
namespace Database_Form1.Database1DataSet1TableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Student] ([Enroll_No], [Name], [Branch], [Sem], [Address], [Gender], [Picture]) VALUES (@Enroll_No, @Name, @Branch, @Sem, @Address, @Gender, @Picture);
SELECT Enroll_No, Name, Branch, Sem, Address, Gender, Picture FROM Student WHERE (Enroll_No = @Enroll_No)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Student] SET [Enroll_No] = @Enroll_No, [Name] = @Name, [Branch] = @Branch, [Sem] = @Sem, [Address] = @Address, [Gender] = @Gender, [Picture] = @Picture WHERE (([Enroll_No] = @Original_Enroll_No) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Branch = 1 AND [Branch] IS NULL) OR ([Branch] = @Original_Branch)) AND ((@IsNull_Sem = 1 AND [Sem] IS NULL) OR ([Sem] = @Original_Sem)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)) AND ((@IsNull_Gender = 1 AND [Gender] IS NULL) OR ([Gender] = @Original_Gender)));
SELECT Enroll_No, Name, Branch, Sem, Address, Gender, Picture FROM Student WHERE (Enroll_No = @Enroll_No)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Database_Form1.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Enroll_No, Name, Branch, Sem, Address, Gender, Picture FROM dbo.Student";
        ...
        public virtual int Delete(int Original_Enroll_No, string Original_Name, string Original_Branch, string Original_Sem, string Original_Address, string Original_Gender) {
        ...
        public virtual int Insert(int Enroll_No, string Name, string Branch, string Sem, string Address, string Gender, byte[] Picture) {
        ...
        public virtual int Update(int Enroll_No, string Name, string Branch, string Sem, string Address, string Gender, byte[] Picture, int Original_Enroll_No, string Original_Name, string Original_Branch, string Original_Sem, string Original_Address, string Original_Gender) {
            ...
            this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_Enroll_No));
            if ((Original_Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Branch, string Sem, string Address, string Gender, byte[] Picture, int Original_Enroll_No, string Original_Name, string Original_Branch, string Original_Sem, string Original_Address, string Original_Gender) {
            return this.Update(Original_Enroll_No, Name, Branch, Sem, Address, Gender, Picture, Original_Enroll_No, Original_Name, Original_Branch, Original_Sem, Original_Address, Original_Gender);
        }
    }
