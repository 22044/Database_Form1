...
namespace Database_Form1 {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public StudentRow AddStudentRow(int Enroll_No, string Name, string Branch, string Sem) {
...
namespace Database_Form1.DataSet1TableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Student] WHERE (([Enroll_No] = @Original_Enroll_No) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Branch = 1 AND [Branch] IS NULL) OR ([Branch] = @Original_Branch)) AND ((@IsNull_Sem = 1 AND [Sem] IS NULL) OR ([Sem] = @Original_Sem)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [Student] ([Enroll_No], [Name], [Branch], [Sem]) VALUES (@Enroll_No, " +
                "@Name, @Branch, @Sem);\r\nSELECT Enroll_No, Name, Branch, Sem FROM Student WHERE (" +
                "Enroll_No = @Enroll_No)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Student] SET [Enroll_No] = @Enroll_No, [Name] = @Name, [Branch] = @Branch, [Sem] = @Sem WHERE (([Enroll_No] = @Original_Enroll_No) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Branch = 1 AND [Branch] IS NULL) OR ([Branch] = @Original_Branch)) AND ((@IsNull_Sem = 1 AND [Sem] IS NULL) OR ([Sem] = @Original_Sem)));
SELECT Enroll_No, Name, Branch, Sem FROM Student WHERE (Enroll_No = @Enroll_No)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Enroll_No, Name, Branch, Sem\r\nFROM     Student";
        ...
        public virtual int Delete(int Original_Enroll_No, string Original_Name, string Original_Branch, string Original_Sem) {
        ...
        public virtual int Insert(int Enroll_No, string Name, string Branch, string Sem) {
        ...
        public virtual int Update(int Enroll_No, string Name, string Branch, string Sem, int Original_Enroll_No, string Original_Name, string Original_Branch, string Original_Sem) {
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((int)(Original_Enroll_No));
            if ((Original_Name == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Name, string Branch, string Sem, int Original_Enroll_No, string Original_Name, string Original_Branch, string Original_Sem) {
            return this.Update(Original_Enroll_No, Name, Branch, Sem, Original_Enroll_No, Original_Name, Original_Branch, Original_Sem);
        }
    }
